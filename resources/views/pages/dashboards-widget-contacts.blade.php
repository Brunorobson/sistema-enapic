        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            ...
            <div class="card px-4 pb-4 sm:px-5">
                <div class="my-3 flex h-8 items-center justify-between">
                    <h2 class="line-clamp-1 text-sm+ font-medium tracking-wide text-slate-700 dark:text-navy-100">
                        Contact List
                    </h2>
                ...
                <label class="relative flex">
                    <input
                        class="peer form-input h-9 w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                    ...
                    <div x-data="accordionItem('item-1')">
                        <div class="flex items-center justify-between">
                            <div class="flex space-x-4">
                                ...
                                <div>
                                    <h3 class="line-clamp-1 font-medium text-slate-700 dark:text-navy-100">
                                        Konnor Guzman
                                    </h3>
                                    <p class="mt-1 line-clamp-1 text-xs">(01) 22 888 4444</p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 line-clamp-1 text-xs">(095)-800-8313</p>
                                </div>
                            </div>
                            <button @click="expanded = !expanded"
                                class="btn h-7 w-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 line-clamp-1 text-xs">(350)-813-3861</p>
                                </div>
                            </div>
                            <button @click="expanded = !expanded"
                                class="btn h-7 w-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 line-clamp-1 text-xs">(675)-975-0083</p>
                                </div>
                            </div>
                            <button @click="expanded = !expanded"
                                class="btn h-7 w-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 line-clamp-1 text-xs">(727)-810-3880</p>
                                </div>
                            </div>
                            <button @click="expanded = !expanded"
                                class="btn h-7 w-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 line-clamp-1 text-xs">(654)-245-9324</p>
                                </div>
                            </div>
                            <button @click="expanded = !expanded"
                                class="btn h-7 w-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
