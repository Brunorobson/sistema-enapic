            ...
            <div class="text-center">
                ...
                <div class="mt-4">
                    ...
                    <p class="dark:text-navy-300 text-slate-400">
                        Entre com o E-mail e Nova Senha para Continuar
                    </p>
                </div>
            </div>
            <div class="card mt-5 rounded-lg p-5 lg:p-7">
                <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <x-label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                                <x-input id="email" class="peer pl-9" placeholder="{{ __('Email') }}"
                                    type="email" name="email" :value="old('email', $request->email)" required autocomplete="username" />
                                <span
                    ...
                    <div class="mt-4">
                        <x-label class="block">
                            <span
                                class="dark:text-navy-300 font-normal text-slate-500">{{ __('Confirm Password') }}:</span>
                            <span class="relative mt-1.5 flex">
